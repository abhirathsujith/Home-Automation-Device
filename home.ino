...
String phone_no1 = "+918971504592"; //change +92 with country code and 3378655465 with phone number to sms
String phone_no2 = "+918867133833"; 
...
if(GSM_Msg=="1on") {load1=0; sendSMS(GSM_Nr,"Ok Load 1 is On");}
if(GSM_Msg=="1off"){load1=1; sendSMS(GSM_Nr,"Ok Load 1 is Off");}

if(GSM_Msg=="2on") {load2=0; sendSMS(GSM_Nr,"Ok Load 2 is On");}
if(GSM_Msg=="2off"){load2=1; sendSMS(GSM_Nr,"Ok Load 2 is Off");}
